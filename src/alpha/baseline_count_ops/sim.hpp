...
// Date:    14.05.2014 23:14:16 CEST
// File:    sim.hpp

#ifndef __COUNT_OPS_SIM_HEADER
#define __COUNT_OPS_SIM_HEADER

#include <types.hpp>
#include <global.hpp>
#include <addon/color.hpp>
#include <addon/accum.hpp>
#include <alpha/baseline_count_ops/grid.hpp>
    ...
    namespace baseline_count_ops {
        struct sim {
            ...
            static std::string name() {
                return "alpha baseline_count_ops";
            }
        };
    }//end namespace baseline_count_ops
}//end namespace mc_potts

#endif //__COUNT_OPS_SIM_HEADER
